...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=36BCF7&width=435&lines=AI+Engineer+%7C+ML+Specialist;Computer+Vision+%7C+NLP+Expert;Full-Stack+Developer;Open+Source+Contributor" alt="Typing SVG" />
</div>
...
**Computer Vision Application | 2024**
- 🎯 **Impact:** 93% plate recognition accuracy
- ⚡ **Tech:** YOLOv8, Django, MySQL
- 🔍 **Features:** Bengali OCR, POS integration
- 📊 **Result:** 500+ daily transactions
...
- 🔬 **Features:** C-ARM integration, real-time analysis
- 🏥 **Result:** Deployed in 3 medical facilities
...
### 📰 NewsNet Classifier
**Bengali NLP Model | 2024**
- 🎯 **Impact:** 92% classification accuracy
- ⚡ **Tech:** TensorFlow, CNN-RNN hybrid
- 🌐 **Features:** Multi-class news categorization
- 📈 **Result:** SOTA performance for Bengali text
